...
if __name__ == '__main__':
    ...
    docs = [doc[0] for doc in train_data]

    p_rank = rank_documents(text, docs, sim_func=pearson)

    c_rank = rank_documents(text, docs, sim_func=cosine)

    pearson_first = p_rank[0]
    cosine_first = c_rank[0]

    print(train_data[pearson_first[1]][0])
    print(train_data[cosine_first[1]][0])
    print(pearson_first[1] == cosine_first[1])